<aside class="hidden lg:flex lg:w-72 lg:flex-col bg-slate-900 text-white shrink-0">
    <div class="flex h-16 items-center gap-3 px-6 border-b border-slate-800">
        <div class="flex h-16 w-16 items-center justify-center rounded-full overflow-hidden flex-shrink-0">
...
<div x-data="{ open: false }" @sidebar-close.window="open = false" class="lg:hidden">
